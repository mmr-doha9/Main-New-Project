Public Class frmArtisticCode
    Implements IFormMainFunction

    Dim strTable As String = "Tblc_ArtisticCode"
    ...
    Public Sub New(frmload As loadType)
        ...
        frmload2 = frmload
    End Sub
    Private Sub frmArtisticCode_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub SDelete() Implements IFormMainFunction.SDelete
        If MsgBox("هل تريد حذف السجل الحالي", CType(MsgBoxStyle.OkCancel + MsgBoxStyle.Critical + MsgBoxStyle.MsgBoxRtlReading + MsgBoxStyle.MsgBoxRight, Global.Microsoft.VisualBasic.MsgBoxStyle), ProgName) = MsgBoxResult.Ok Then
            If FCheckDelete(Val(TxtBox1.Text), "ArtisticCode") = True Then
    ...
    Private Sub _KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
