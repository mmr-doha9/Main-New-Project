Public Class frmAlert
    ...
    Public Sub LoadData()
        ...
        For i As Integer = 0 To DataGridView1.RowCount - 1
            DataGridView1.Item(1, i).Value = FGetFeildValues("Tblc_UserCode", "UserName", "UserCode=" & "'" & DataGridView1.Item(0, i).Value & "'", False)
            DataGridView1.Item(3, i).Value = FGetFeildValues("Tblc_UserCode", "UserName", "UserCode=" & "'" & DataGridView1.Item(0, i).Value & "'", False)
        Next
    End Sub
