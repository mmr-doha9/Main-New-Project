Public Class frmAccountMenCode
    Implements IFormMainFunction

    Dim strTable As String = "Tblc_AccountMenCode"
    ...
    Private Sub frmAccountMenCode_Load(sender As Object, e As EventArgs) Handles Me.Load
        'Me.MdiParent = Mdi
        'Call SAddNew()
    ...
    Private Sub TabControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TabControl1.KeyDown, TxtBox2.KeyDown, TxtBox3.KeyDown, TxtBox4.KeyDown, TxtBox5.KeyDown, TxtBox6.KeyDown, TxtBox7.KeyDown, TxtBox8.KeyDown
